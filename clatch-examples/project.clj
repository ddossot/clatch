(defproject net.dossot.clatch/clatch-examples "1.0.0-SNAPSHOT"
  :description "Clatch examples."
  ...
  :profiles {:provided {:dependencies [[net.dossot.clatch/clatch-core :version]]}})
